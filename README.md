...
# 🔥👀 Azure Deployment
I deployed it on Azure by github actions using the free App Service, so it might be a bit slow. Here’s the link https://flightplannerweb-dcb3fsgrfbanfhfu.westeurope-01.azurewebsites.net/ you can test it.
